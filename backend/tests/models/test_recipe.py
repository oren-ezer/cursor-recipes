...
def test_create_recipe_instance():
    ...
    assert recipe.description == recipe_data["description"]
    ...
    assert recipe.user == recipe_data["user"]
    assert recipe.id is None  # Assuming id is generated by the DB or BaseModel
